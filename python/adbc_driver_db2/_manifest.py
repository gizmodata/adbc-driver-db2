...
name (``driver = "db2"``) or URI scheme (``uri = "db2://..."``).
The driver manager resolves that name by finding a ``db2.toml``
...
def render_manifest() -> str:
    """Render the db2.toml driver manifest for this installation."""
    ...
    return f"""\
manifest_version = 1
name = 'ADBC Db2 Driver - Go'
publisher = 'GizmoData'
version = '{__version__}'
license = 'MIT'
url = 'https://github.com/gizmodata/adbc-driver-db2'
...
def install_manifest(
    ...
    """
    Write the ``db2.toml`` driver manifest and return its path.

    After this, ``adbc_driver_manager.dbapi.connect(uri="db2://...")``
    and connection profiles with ``driver = "db2"`` resolve this
