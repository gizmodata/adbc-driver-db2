...
//
// int Db2ArrayStreamGetSchema(struct ArrowArrayStream*, struct ArrowSchema*);
// int Db2ArrayStreamGetNext(struct ArrowArrayStream*, struct ArrowArray*);
// const char* Db2ArrayStreamGetLastError(struct ArrowArrayStream*);
// void Db2ArrayStreamRelease(struct ArrowArrayStream*);
//
// int Db2ArrayStreamGetSchemaTrampoline(struct ArrowArrayStream*, struct ArrowSchema*);
// int Db2ArrayStreamGetNextTrampoline(struct ArrowArrayStream*, struct ArrowArray*);
//
...
import (
	...
	db2 "github.com/gizmodata/adbc-driver-db2/driver/db2"
)

// Must use malloc() to respect CGO rules
var drv = db2.NewDriver(mallocator.NewMallocator())
...
func setErr(err *C.struct_AdbcError, format string, vals ...interface{}) {
	...
	err.release = (*[0]byte)(C.Db2_release_error)
}
...
func setErrWithDetails(err *C.struct_AdbcError, adbcError adbc.Error) {
	...
	cErrPtr := C.calloc(C.sizeof_struct_Db2Error, C.size_t(1))
	cErr := (*C.struct_Db2Error)(cErrPtr)
	cErr.message = C.CString(adbcError.Msg)
	err.message = cErr.message
	err.release = (*[0]byte)(C.Db2ReleaseErrWithDetails)
...
func poison(err *C.struct_AdbcError, fname string, e interface{}) C.AdbcStatusCode {
	if !globalPoison.Swap(true) {
		...
		fmt.Fprintf(os.Stderr, "Db2 driver panicked, stack traces:\n%s", buf[:length])
	}
	setErr(err, "%s: Go panic in Db2 driver (see stderr): %#v", fname, e)
...
func initLoggingFromEnv(db adbc.Database) {
	...
	if !ok {
		logger.Error("Db2 does not support logging")
		return
	}
...
func printLoggingHelp() {
	fmt.Fprintf(os.Stderr, "Db2: to enable logging, set %s to 'debug', 'info', 'warn', or 'error'", logLevelEnvVar)
}
...
func (cStream *cArrayStream) maybeError() C.int {
	...
	if err != nil {
		if cStream.adbcErr != nil {
			C.Db2errRelease(cStream.adbcErr)
		} else {
...
//export Db2ArrayStreamGetLastError
func Db2ArrayStreamGetLastError(stream *C.struct_ArrowArrayStream) *C.cchar_t {
	if stream == nil || stream.release != (*[0]byte)(C.Db2ArrayStreamRelease) || stream.private_data == nil {
		return nil
	}
...
//export Db2ArrayStreamGetNext
func Db2ArrayStreamGetNext(stream *C.struct_ArrowArrayStream, array *C.struct_ArrowArray) C.int {
	if stream == nil || stream.release != (*[0]byte)(C.Db2ArrayStreamRelease) || stream.private_data == nil {
		return C.EINVAL
	}
	cStream := getFromHandle[cArrayStream](stream.private_data)
...
//export Db2ArrayStreamGetSchema
func Db2ArrayStreamGetSchema(stream *C.struct_ArrowArrayStream, schema *C.struct_ArrowSchema) C.int {
	if stream == nil || stream.release != (*[0]byte)(C.Db2ArrayStreamRelease) || stream.private_data == nil {
		return C.EINVAL
	}
	cStream := getFromHandle[cArrayStream](stream.private_data)
...
//export Db2ArrayStreamRelease
func Db2ArrayStreamRelease(stream *C.struct_ArrowArrayStream) {
	if stream == nil || stream.release != (*[0]byte)(C.Db2ArrayStreamRelease) || stream.private_data == nil {
		return
	}
...
//export Db2ErrorFromArrayStream
func Db2ErrorFromArrayStream(stream *C.struct_ArrowArrayStream, status *C.AdbcStatusCode) *C.struct_AdbcError {
	if stream == nil || stream.release != (*[0]byte)(C.Db2ArrayStreamRelease) || stream.private_data == nil {
		return nil
	}
	cStream := getFromHandle[cArrayStream](stream.private_data)
...
func exportRecordReader(rdr array.RecordReader, stream *C.struct_ArrowArrayStream) {
	...
	stream.get_last_error = (*[0]byte)(C.Db2ArrayStreamGetLastError)
	stream.get_next = (*[0]byte)(C.Db2ArrayStreamGetNextTrampoline)
	stream.get_schema = (*[0]byte)(C.Db2ArrayStreamGetSchemaTrampoline)
	stream.release = (*[0]byte)(C.Db2ArrayStreamRelease)
...
//export Db2DatabaseGetOption
func Db2DatabaseGetOption(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.char, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2DatabaseGetOptionBytes
func Db2DatabaseGetOptionBytes(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.uint8_t, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2DatabaseGetOptionDouble
func Db2DatabaseGetOptionDouble(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2DatabaseGetOptionInt
func Db2DatabaseGetOptionInt(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2DatabaseInit
func Db2DatabaseInit(db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2DatabaseNew
func Db2DatabaseNew(db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2DatabaseRelease
func Db2DatabaseRelease(db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
			code = poison(err, "AdbcDatabaseInit", e)
		}
...
//export Db2DatabaseSetOption
func Db2DatabaseSetOption(db *C.struct_AdbcDatabase, key, value *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2DatabaseSetOptionBytes
func Db2DatabaseSetOptionBytes(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2DatabaseSetOptionDouble
func Db2DatabaseSetOptionDouble(db *C.struct_AdbcDatabase, key *C.cchar_t, value C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2DatabaseSetOptionInt
func Db2DatabaseSetOptionInt(db *C.struct_AdbcDatabase, key *C.cchar_t, value C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2ConnectionGetOption
func Db2ConnectionGetOption(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.char, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2ConnectionGetOptionBytes
func Db2ConnectionGetOptionBytes(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.uint8_t, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2ConnectionGetOptionDouble
func Db2ConnectionGetOptionDouble(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2ConnectionGetOptionInt
func Db2ConnectionGetOptionInt(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2ConnectionNew
func Db2ConnectionNew(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2ConnectionSetOption
func Db2ConnectionSetOption(cnxn *C.struct_AdbcConnection, key, val *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2ConnectionSetOptionBytes
func Db2ConnectionSetOptionBytes(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2ConnectionSetOptionDouble
func Db2ConnectionSetOptionDouble(db *C.struct_AdbcConnection, key *C.cchar_t, value C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2ConnectionSetOptionInt
func Db2ConnectionSetOptionInt(db *C.struct_AdbcConnection, key *C.cchar_t, value C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2ConnectionInit
func Db2ConnectionInit(cnxn *C.struct_AdbcConnection, db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2ConnectionRelease
func Db2ConnectionRelease(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2ConnectionCancel
func Db2ConnectionCancel(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2ConnectionGetInfo
func Db2ConnectionGetInfo(cnxn *C.struct_AdbcConnection, codes *C.cuint32_t, len C.size_t, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2ConnectionGetObjects
func Db2ConnectionGetObjects(cnxn *C.struct_AdbcConnection, depth C.int, catalog, dbSchema, tableName *C.cchar_t, tableType **C.cchar_t, columnName *C.cchar_t,
...
//export Db2ConnectionGetStatistics
func Db2ConnectionGetStatistics(cnxn *C.struct_AdbcConnection, catalog, dbSchema, tableName *C.cchar_t, approximate C.char, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2ConnectionGetStatisticNames
func Db2ConnectionGetStatisticNames(cnxn *C.struct_AdbcConnection, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
			code = poison(err, "AdbcConnectionGetStatistics", e)
		}
...
//export Db2ConnectionGetTableSchema
func Db2ConnectionGetTableSchema(cnxn *C.struct_AdbcConnection, catalog, dbSchema, tableName *C.cchar_t, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2ConnectionGetTableTypes
func Db2ConnectionGetTableTypes(cnxn *C.struct_AdbcConnection, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2ConnectionReadPartition
func Db2ConnectionReadPartition(cnxn *C.struct_AdbcConnection, serialized *C.cuint8_t, serializedLen C.size_t, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2ConnectionCommit
func Db2ConnectionCommit(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2ConnectionRollback
func Db2ConnectionRollback(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2StatementGetOption
func Db2StatementGetOption(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.char, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2StatementGetOptionBytes
func Db2StatementGetOptionBytes(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.uint8_t, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2StatementGetOptionDouble
func Db2StatementGetOptionDouble(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2StatementGetOptionInt
func Db2StatementGetOptionInt(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2StatementNew
func Db2StatementNew(cnxn *C.struct_AdbcConnection, stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2StatementRelease
func Db2StatementRelease(stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2StatementCancel
func Db2StatementCancel(stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2StatementPrepare
func Db2StatementPrepare(stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2StatementExecuteQuery
func Db2StatementExecuteQuery(stmt *C.struct_AdbcStatement, out *C.struct_ArrowArrayStream, affected *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2StatementExecuteSchema
func Db2StatementExecuteSchema(stmt *C.struct_AdbcStatement, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
			code = poison(err, "AdbcStatementExecuteQuery", e)
		}
...
//export Db2StatementSetSqlQuery
func Db2StatementSetSqlQuery(stmt *C.struct_AdbcStatement, query *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2StatementSetSubstraitPlan
func Db2StatementSetSubstraitPlan(stmt *C.struct_AdbcStatement, plan *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2StatementBind
func Db2StatementBind(stmt *C.struct_AdbcStatement, values *C.struct_ArrowArray, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2StatementBindStream
func Db2StatementBindStream(stmt *C.struct_AdbcStatement, stream *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2StatementGetParameterSchema
func Db2StatementGetParameterSchema(stmt *C.struct_AdbcStatement, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2StatementSetOption
func Db2StatementSetOption(stmt *C.struct_AdbcStatement, key, value *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2StatementSetOptionBytes
func Db2StatementSetOptionBytes(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2StatementSetOptionDouble
func Db2StatementSetOptionDouble(db *C.struct_AdbcStatement, key *C.cchar_t, value C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2StatementSetOptionInt
func Db2StatementSetOptionInt(db *C.struct_AdbcStatement, key *C.cchar_t, value C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export Db2StatementExecutePartitions
func Db2StatementExecutePartitions(stmt *C.struct_AdbcStatement, schema *C.struct_ArrowSchema, partitions *C.struct_AdbcPartitions, affected *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export AdbcDriverDb2Init
func AdbcDriverDb2Init(version C.int, rawDriver *C.void, err *C.struct_AdbcError) C.AdbcStatusCode {
	...
	driver.DatabaseInit = (*[0]byte)(C.Db2DatabaseInit)
	driver.DatabaseNew = (*[0]byte)(C.Db2DatabaseNew)
	driver.DatabaseRelease = (*[0]byte)(C.Db2DatabaseRelease)
	driver.DatabaseSetOption = (*[0]byte)(C.Db2DatabaseSetOption)

	driver.ConnectionNew = (*[0]byte)(C.Db2ConnectionNew)
	driver.ConnectionInit = (*[0]byte)(C.Db2ConnectionInit)
	driver.ConnectionRelease = (*[0]byte)(C.Db2ConnectionRelease)
	driver.ConnectionSetOption = (*[0]byte)(C.Db2ConnectionSetOption)
	driver.ConnectionGetInfo = (*[0]byte)(C.Db2ConnectionGetInfo)
	driver.ConnectionGetObjects = (*[0]byte)(C.Db2ConnectionGetObjects)
	driver.ConnectionGetTableSchema = (*[0]byte)(C.Db2ConnectionGetTableSchema)
	driver.ConnectionGetTableTypes = (*[0]byte)(C.Db2ConnectionGetTableTypes)
	driver.ConnectionReadPartition = (*[0]byte)(C.Db2ConnectionReadPartition)
	driver.ConnectionCommit = (*[0]byte)(C.Db2ConnectionCommit)
	driver.ConnectionRollback = (*[0]byte)(C.Db2ConnectionRollback)

	driver.StatementNew = (*[0]byte)(C.Db2StatementNew)
	driver.StatementRelease = (*[0]byte)(C.Db2StatementRelease)
	driver.StatementSetOption = (*[0]byte)(C.Db2StatementSetOption)
	driver.StatementSetSqlQuery = (*[0]byte)(C.Db2StatementSetSqlQuery)
	driver.StatementSetSubstraitPlan = (*[0]byte)(C.Db2StatementSetSubstraitPlan)
	driver.StatementBind = (*[0]byte)(C.Db2StatementBind)
	driver.StatementBindStream = (*[0]byte)(C.Db2StatementBindStream)
	driver.StatementExecuteQuery = (*[0]byte)(C.Db2StatementExecuteQuery)
	driver.StatementExecutePartitions = (*[0]byte)(C.Db2StatementExecutePartitions)
	driver.StatementGetParameterSchema = (*[0]byte)(C.Db2StatementGetParameterSchema)
	driver.StatementPrepare = (*[0]byte)(C.Db2StatementPrepare)

	if version == C.ADBC_VERSION_1_1_0 {
		driver.ErrorGetDetailCount = (*[0]byte)(C.Db2ErrorGetDetailCount)
		driver.ErrorGetDetail = (*[0]byte)(C.Db2ErrorGetDetail)
		driver.ErrorFromArrayStream = (*[0]byte)(C.Db2ErrorFromArrayStream)

		driver.DatabaseGetOption = (*[0]byte)(C.Db2DatabaseGetOption)
		driver.DatabaseGetOptionBytes = (*[0]byte)(C.Db2DatabaseGetOptionBytes)
		driver.DatabaseGetOptionDouble = (*[0]byte)(C.Db2DatabaseGetOptionDouble)
		driver.DatabaseGetOptionInt = (*[0]byte)(C.Db2DatabaseGetOptionInt)
		driver.DatabaseSetOptionBytes = (*[0]byte)(C.Db2DatabaseSetOptionBytes)
		driver.DatabaseSetOptionDouble = (*[0]byte)(C.Db2DatabaseSetOptionDouble)
		driver.DatabaseSetOptionInt = (*[0]byte)(C.Db2DatabaseSetOptionInt)

		driver.ConnectionCancel = (*[0]byte)(C.Db2ConnectionCancel)
		driver.ConnectionGetOption = (*[0]byte)(C.Db2ConnectionGetOption)
		driver.ConnectionGetOptionBytes = (*[0]byte)(C.Db2ConnectionGetOptionBytes)
		driver.ConnectionGetOptionDouble = (*[0]byte)(C.Db2ConnectionGetOptionDouble)
		driver.ConnectionGetOptionInt = (*[0]byte)(C.Db2ConnectionGetOptionInt)
		driver.ConnectionGetStatistics = (*[0]byte)(C.Db2ConnectionGetStatistics)
		driver.ConnectionGetStatisticNames = (*[0]byte)(C.Db2ConnectionGetStatisticNames)
		driver.ConnectionSetOptionBytes = (*[0]byte)(C.Db2ConnectionSetOptionBytes)
		driver.ConnectionSetOptionDouble = (*[0]byte)(C.Db2ConnectionSetOptionDouble)
		driver.ConnectionSetOptionInt = (*[0]byte)(C.Db2ConnectionSetOptionInt)

		driver.StatementCancel = (*[0]byte)(C.Db2StatementCancel)
		driver.StatementExecuteSchema = (*[0]byte)(C.Db2StatementExecuteSchema)
		driver.StatementGetOption = (*[0]byte)(C.Db2StatementGetOption)
		driver.StatementGetOptionBytes = (*[0]byte)(C.Db2StatementGetOptionBytes)
		driver.StatementGetOptionDouble = (*[0]byte)(C.Db2StatementGetOptionDouble)
		driver.StatementGetOptionInt = (*[0]byte)(C.Db2StatementGetOptionInt)
		driver.StatementSetOptionBytes = (*[0]byte)(C.Db2StatementSetOptionBytes)
		driver.StatementSetOptionDouble = (*[0]byte)(C.Db2StatementSetOptionDouble)
		driver.StatementSetOptionInt = (*[0]byte)(C.Db2StatementSetOptionInt)
	}
